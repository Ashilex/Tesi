...
\caption{Un immagine di un neurone ottenuta al microscopio da John Anderson, Institute for Neuroinformatics, Zurich, Switzerland.}
\label{fig:subfig}
\end{figure}
...
Il lavoro di Minsky e Papert mostrò i limiti dell'apprendimento del perceptrone e delle reti neurali a singolo strato\cite{minsky2017perceptrons}. Gli iniziali successi condussero ad esagerare potenziale ed aspettative nei confronti delle reti neurali, generando in un primo momento clamore e diffidenza, paura anche rispetto a quallo che avrebbe potuto costituirsi come rapporto uomo-macchina e in seguito in delusione verso le aspettative non ripagate. 
